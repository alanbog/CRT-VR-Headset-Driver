...
namespace Relativty {
  ...
  static const char *const k_pch_ExtDisplay_FocalLength_Float = "FocalLengthMeters";
  static const char *const k_pch_ExtDisplay_DisplayHeight_Float = "DisplayHeightMeters";
  static const char *const k_pch_ExtDisplay_DisplayWidth_Float = "DisplayWidthMeters";
  static const char *const k_pch_ExtDisplay_DisplayOffset_Float = "DisplayOffsetMeters";
  ...
  static const char *const k_pch_HMD_Section = "Relativty_hmd";
  static const char *const k_pch_HMD_IPD_float = "IPDmeters";
  ...
  public:
    RelativtyExtendedDisplayComponent(){
      ...
      m_focal_length = vr::VRSettings()->GetFloat(k_pch_ExtDisplay_Section, k_pch_ExtDisplay_FocalLength_Float);
      m_display_height = vr::VRSettings()->GetFloat(k_pch_ExtDisplay_Section, k_pch_ExtDisplay_DisplayHeight_Float);
      m_display_width = vr::VRSettings()->GetFloat(k_pch_ExtDisplay_Section, k_pch_ExtDisplay_DisplayWidth_Float);
      m_display_offset = vr::VRSettings()->GetFloat(k_pch_ExtDisplay_Section, k_pch_ExtDisplay_DisplayOffset_Float);
      m_ipd = vr::VRSettings()->GetFloat(k_pch_HMD_Section, k_pch_HMD_IPD_float);
    ...
    virtual void GetProjectionRaw(vr::EVREye eEye, float* pfLeft, float* pfRight,
        ...
        float tan_x_inner = (m_ipd / 2 - m_display_offset) / m_focal_length;
        float tan_x_outer = (m_display_offset + m_display_width - m_ipd / 2) / m_focal_length;
        float tan_y = m_display_height / m_focal_length / 2;
