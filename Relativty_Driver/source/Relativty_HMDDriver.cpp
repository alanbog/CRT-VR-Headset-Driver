...
inline void Relativty::HMDDriver::setProperties() {
	...
	//properties added to original reletivty driver (some of these needed for VRChat to work properly)
	vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_ModelNumber_String, "0");
	vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_RenderModelName_String, "");
	vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_SerialNumber_String, "000000");
	vr::VRProperties()->SetBoolProperty(m_ulPropertyContainer, vr::Prop_WillDriftInYaw_Bool, false);
	vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_ManufacturerName_String, "Relativty");
	vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_TrackingFirmwareVersion_String, "1.0");
	vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_HardwareRevision_String, "1.0");
	...
	vr::VRProperties()->SetBoolProperty(m_ulPropertyContainer, vr::Prop_CanUnifyCoordinateSystemWithHmd_Bool, true);
	...
	vr::VRProperties()->SetStringProperty(m_ulPropertyContainer, vr::Prop_DriverVersion_String, "1");
	...
	vr::VRProperties()->SetUint64Property(m_ulPropertyContainer, vr::Prop_DisplayFirmwareVersion_Uint64, 1);
	vr::VRProperties()->SetBoolProperty(m_ulPropertyContainer, vr::Prop_DisplayAllowNightMode_Bool, true);
	vr::VRProperties()->SetInt32Property(m_ulPropertyContainer, vr::Prop_ExpectedControllerCount_Int32, 2);
	vr::VRProperties()->SetInt32Property(m_ulPropertyContainer, vr::Prop_HmdTrackingStyle_Int32, vr::HmdTrackingStyle_Lighthouse);
}
